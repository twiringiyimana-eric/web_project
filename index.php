...
<body style="font-family:Georgia, 'Times New Roman', Times, serif; background-image:url(img/new.jpg)">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title"style="font-family:Georgia, 'Times New Roman', Times, serif;">User Login </h2>
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								...
								<form action="" class="mt" method="post">
									...
									<input type="submit" name="login" class="btn btn-primary btn-block" value="Login" style="border-radius:10px;background-color:skyblue" >
								</form>
							</div>
						</div>
